...
- [ ] 3、需要将操作记录在 log 文件中，这个文件将显示重要的时间点，在日志的界面中

- [ ] 4、在3d界面中，对于轨迹需要有清除功能，能正确分辨出一个合理的飞行

- [x] 5、优化模型，找到一个更合适更漂亮的模型

- [x] 6、自动导播有bug，轨迹观察也会触动自动导播
...
- [ ] 11、日志与前端联系起来，修改后端脚本，每次传入数据先记录飞机型号（数据集名字记录的信息）然后再日志中更新
